...
- (IBAction)answeredYes:(id)sender {
	if (![self.rootViewController.currentSurvey.question4Answer isEqualToString:@"Yes"]) {
...
- (IBAction)answeredNo:(id)sender {
	if (![self.rootViewController.currentSurvey.question4Answer isEqualToString:@"No"]) {
